...
awful.layout.layouts = {
    ...
    awful.layout.suit.tile.bottom, awful.layout.suit.corner.nw,
...
globalkeys = gears.table.join(awful.key({modkey}, "s", hotkeys_popup.show_help,
    ...
    group = "tag"
              ...
              {description = "go back", group = "tag"}), -- Scratchpad terminal
awful.key({modkey}, "u", function()
    ...
    scratch.toggle(terminal .. " -t scratch-htop -e nice -n 19 btm --battery",
                   {name = "scratch-htop"})
end, {description = "Toggle the tmux scratchpad", group = "tag"}),
...
awful.key({modkey}, "Return", function() awful.spawn(terminal) end,
          {description = "open a terminal", group = "launcher"}),
                              awful.key({modkey, "Control"}, "Return",
                                        function()
    awful.util.spawn("sh -c '" .. terminal ..
...
awful.key({}, "XF86AudioMute", function() awful.spawn("volumectl -t") end,
    ...
    awful.spawn("volumectl -i")
                              ...
                              awful.key({"Shift"}, "XF86AudioRaiseVolume",
                                        function() awful.spawn("volumectl -I") end,
                                        {
    description = "Increase volume a lot",
    group = "Media management"
}), awful.key({}, "XF86AudioLowerVolume",
              function() awful.spawn("volumectl -d") end,
    ...
    }, -- Floating clients.
    {
        rule_any = {
            ...
            class = {
                ...
                "Sxiv", "Timeshift", "Tor Browser", -- Needs a fixed window size to avoid fingerprinting by screen size.
                "Wpa_gui", "veromix", "Nm-connection-editor", "xtightvncviewer",
                "gksqt", "feh", "GeoGebra to PGF Export", "mpv"
            },
