...
prompt_pure_state_setup() {
	...
	hostname_highlighted='%F{$prompt_pure_colors[host:highlighted]}%m%f'
	# Show `username@host` if logged in through SSH.
    [[ -n $ssh_connection ]] && username='%F{$prompt_pure_colors[user]}%n'"@$hostname_highlighted" || username='%F{$prompt_pure_colors[host]}'"$hostname"
